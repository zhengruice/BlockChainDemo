...
export const JEditableTableModelMixin = {
  ...
  methods: {
    ...
    //清空某一jEditTable 根据ref
    clearJEditTableByRef(ref){
      if (!(this.refKeys instanceof Array)) {
        throw this.throwNotArray('refKeys')
      }
    ...
    requestSubTableData(url, params, tab, success) {
      ...
      getAction(url, params).then(res => {
        ...
        /* dataSource.forEach(function(item, idnex, array){
            tab.selectedRowKeys[index] = dataSource[index].inentoryId;
            tab.selectedRows[index] = dataSource[index];
        }); */
