  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/basMaterial/basMaterial/list",
          delete: "/basMaterial/basMaterial/delete",
          deleteBatch: "/basMaterial/basMaterial/deleteBatch",
          exportXlsUrl: "/basMaterial/basMaterial/exportXls",
          importExcelUrl: "basMaterial/basMaterial/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'int',value:'isTax',text:'是否含税',dictCode:'yn'})
