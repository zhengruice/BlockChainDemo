<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <!-- <a-button type="primary" icon="download" @click="handleExportXls('材料类别表')">导出</a-button>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/basMaterialCategory/basMaterialCategory/rootList",
          childList: "/basMaterialCategory/basMaterialCategory/childList",
          getChildListBatch: "/basMaterialCategory/basMaterialCategory/getChildListBatch",
          delete: "/basMaterialCategory/basMaterialCategory/delete",
          deleteBatch: "/basMaterialCategory/basMaterialCategory/deleteBatch",
          exportXlsUrl: "/basMaterialCategory/basMaterialCategory/exportXls",
          importExcelUrl: "basMaterialCategory/basMaterialCategory/importExcel",
        },
        expandedRowKeys:[],
