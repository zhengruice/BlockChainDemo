...
<!--      <j-super-query :fieldList="superFieldList" ref="superQueryModal" @handleSuperQuery="handleSuperQuery"></j-super-query>-->
    ...
    <bas-product-modal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
...
<script>
  ...
  import BasProductModal from './modules/BasProductModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/basProduct/basProduct/list",
          delete: "/basProduct/basProduct/delete",
          deleteBatch: "/basProduct/basProduct/deleteBatch",
          exportXlsUrl: "/basProduct/basProduct/exportXls",
          importExcelUrl: "basProduct/basProduct/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
         ...
         fieldList.push({type:'string',value:'categoryId',text:'类别'})
