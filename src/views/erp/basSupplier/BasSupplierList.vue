          ...
          <template v-if="toggleSearchStatus">
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="联系人">
                <a-input placeholder="请输入联系人" v-model="queryParam.contacts"></a-input>
              </a-form-item>
            </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/basSupplier/basSupplier/list",
          delete: "/basSupplier/basSupplier/delete",
          deleteBatch: "/basSupplier/basSupplier/deleteBatch",
          exportXlsUrl: "/basSupplier/basSupplier/exportXls",
          importExcelUrl: "basSupplier/basSupplier/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'BigDecimal',value:'wallet',text:'钱包',dictCode:''})
