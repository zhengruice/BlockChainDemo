...
<!--      <a-button type="primary" icon="download" @click="handleExportXls('bas_warehouse')">导出</a-button>-->
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/basWarehouse/basWarehouse/rootList",
          childList: "/basWarehouse/basWarehouse/childList",
          getChildListBatch: "/basWarehouse/basWarehouse/getChildListBatch",
          delete: "/basWarehouse/basWarehouse/delete",
          deleteBatch: "/basWarehouse/basWarehouse/deleteBatch",
          exportXlsUrl: "/basWarehouse/basWarehouse/exportXls",
          importExcelUrl: "basWarehouse/basWarehouse/importExcel",
        },
        expandedRowKeys:[],
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
        fieldList.push({type:'string',value:'pid',text:'父级'})
