...
<!--  </div>-->
    <div class="no-print" style="text-align: right;margin:0.5rem">
...
<script>
  ...
  import ListColumnsSetter from './ListColumnsSetter'
  import EditableTableColumnsSetter from './EditableTableColumnsSetter'



  export default {
    name: "OnlCgreportModal",
    ...
    methods: {
      ...
      exportExcel() {
        ...
        downFile(`/online/cgreport/api/exportXls/${this.reportId}`, Object.assign(selfParam, this.queryParam)).then((data) => {
          if (!data) {
