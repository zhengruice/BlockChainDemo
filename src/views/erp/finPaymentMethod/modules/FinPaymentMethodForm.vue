  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/finPaymentMethod/finPaymentMethod/add",
          edit: "/finPaymentMethod/finPaymentMethod/edit",
          queryById: "/finPaymentMethod/finPaymentMethod/queryById"
        }
      }
    },
    computed: {
    ...
    methods: {
      add () {
        ...
        const ruleCode = 'payment_method_code'
