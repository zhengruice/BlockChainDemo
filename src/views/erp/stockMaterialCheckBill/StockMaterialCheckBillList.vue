<template>
  <a-card :bordered="false">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="材料类别">
                <j-tree-select
                  ref="treeSelect"
                  placeholder="请选择材料类别"
                  v-model="queryParam.materialCategoryId"
    ...
    <div class="table-operator">
      ...
      <!-- <a-button type="primary" icon="download" @click="handleExportXls('材料库存盘点')">导出</a-button>
    ...
    <stock-material-check-bill-modal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
...
<script>
  ...
  import StockMaterialCheckBillModal from './modules/StockMaterialCheckBillModal'
  import {filterMultiDictText} from '@/components/dict/JDictSelectUtil'
  import '@/assets/less/TableExpand.less'

  export default {
    name: "StockMaterialCheckBillList",
    mixins:[JeecgListMixin],
    components: {
      StockMaterialCheckBillModal
    },
    data () {
      return {
        description: '材料库存盘点管理页面',
        // 表头
        columns: [
          {
            title: '#',
        ...
        url: {
          list: "/stockMaterialCheckBill/stockMaterialCheckBill/list",
          delete: "/stockMaterialCheckBill/stockMaterialCheckBill/delete",
          deleteBatch: "/stockMaterialCheckBill/stockMaterialCheckBill/deleteBatch",
          exportXlsUrl: "/stockMaterialCheckBill/stockMaterialCheckBill/exportXls",
          importExcelUrl: "stockMaterialCheckBill/stockMaterialCheckBill/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
         ...
         fieldList.push({type:'string',value:'materialCategoryId',text:'材料类别'})
