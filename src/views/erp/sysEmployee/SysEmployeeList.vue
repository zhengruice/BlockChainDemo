<template>
  <a-card :bordered="false">
          ...
          <template v-if="toggleSearchStatus">
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="入职日期">
                <j-date placeholder="请选择入职日期" v-model="queryParam.entryTime"></j-date>
              </a-form-item>
            </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <sys-employee-modal ref="modalForm" @ok="modalFormOk"></sys-employee-modal>
  </a-card>
</template>
...
<script>
  ...
  import SysEmployeeModal from './modules/SysEmployeeModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/sysEmployee/sysEmployee/list",
          delete: "/sysEmployee/sysEmployee/delete",
          deleteBatch: "/sysEmployee/sysEmployee/deleteBatch",
          exportXlsUrl: "/sysEmployee/sysEmployee/exportXls",
          importExcelUrl: "sysEmployee/sysEmployee/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'date',value:'entryTime',text:'入职日期'})
