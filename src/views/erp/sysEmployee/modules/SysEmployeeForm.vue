  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/sysEmployee/sysEmployee/add",
          edit: "/sysEmployee/sysEmployee/edit",
          queryById: "/sysEmployee/sysEmployee/queryById"
        }
      }
    },
    computed: {
