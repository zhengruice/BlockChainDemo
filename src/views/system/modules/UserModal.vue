    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item label="用户账号" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="username">
          <a-input :disabled="disableSubmit" placeholder="请输入用户账号" v-model="model.username" :readOnly="!!model.id"/>
        </a-form-model-item>
        ...
        <template v-if="!model.id">
          ...
          <a-form-model-item label="确认密码" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="confirmpassword" >
            <a-input :disabled="disableSubmit" type="password" @blur="handleConfirmBlur" placeholder="请重新输入登录密码" v-model="model.confirmpassword"/>
          </a-form-model-item>
        </template>
...
<!--          <j-select-position :disabled="disableSubmit" placeholder="请选择职务" :multiple="false" v-model="model.post"/>-->
<!--        </a-form-model-item>-->
        ...
        <a-form-model-item label="部门分配" :labelCol="labelCol" :wrapperCol="wrapperCol" v-show="!departDisabled">
          <j-select-depart :disabled="disableSubmit"  v-model="model.selecteddeparts" :multi="true" @back="backDepartInfo" :backDepart="true"></j-select-depart>
        </a-form-model-item>
...
<!--        </a-form-model-item>-->
        ...
        <a-form-model-item label="头像" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-image-upload  :disabled="disableSubmit" class="avatar-uploader" text="上传" v-model="model.avatar" ></j-image-upload>
        </a-form-model-item>
        ...
        <a-form-model-item label="性别" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-select :disabled="disableSubmit"  v-model="model.sex"  placeholder="请选择性别" :getPopupContainer= "(target) => target.parentNode">
